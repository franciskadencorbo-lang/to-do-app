...
// Clicking "View Tasks" opens the day's task popover (see below).
...
// Click-triggered (not hover) and rendered into a single shared popover
// outside the calendar grid, same pattern as the dependency-edit popover
// below — a hover tooltip nested inside the day cell used to disappear the
// moment the mouse moved toward it, before a task link inside could be clicked.
